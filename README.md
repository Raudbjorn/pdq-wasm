...
```html
<script type="module">
  import { PDQ } from 'https://unpkg.com/pdq-wasm@0.3.8/dist/esm/index.js';
...
- **unpkg** (default): `https://unpkg.com/pdq-wasm@0.3.8/wasm/pdq.wasm`
- **jsDelivr**: `https://cdn.jsdelivr.net/npm/pdq-wasm@0.3.6/wasm/pdq.wasm`
- **unpkg (latest)**: `https://unpkg.com/pdq-wasm@0.3.8/wasm/pdq.wasm`
